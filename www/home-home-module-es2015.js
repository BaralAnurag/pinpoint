...
let HomePage = class HomePage {
    constructor(alertController, maps, storage) {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.addresses = yield this.storage.getAddresses();
        });
    }
    onMapClick(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const place = event.placeId || event.coords;
            const address = yield this.maps.geocode(place);
            this.selectedAddress = yield this.storage.saveAddress(address);
    ...
    doDelete(address) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.storage.deleteAddress(address.addressId);
...
let MapsService = class MapsService {
    ...
    geocode(placeIdOrLocation) {
        return new Promise((resolve, reject) => {
            const params = typeof placeIdOrLocation === 'string'
...
let StorageService = class StorageService {
    ...
    saveAddress(address) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.storage.set(address.addressId, address);
            return address;
        });
    }
    getAddresses() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const addresses = [];
            yield this.storage.forEach(address => {
                if (address.addressId) {
